...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/concerttoursstorefront/electronics/en",
						"https://electronics.local:9002/concerttoursstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/concerttoursstorefront/electronics/en",
						"https://electronics.local:9002/concerttoursstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/concerttoursstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/concerttoursstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/concerttoursstorefront/electronics/en",
						"https://electronics.local:9002/concerttoursstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/concerttoursstorefront",
						"https://electronics.local:9002/concerttoursstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/concerttoursstorefront",
						"https://electronics.local:9002/concerttoursstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/concerttoursstorefront/electronics/en",
						"https://electronics.local:9002/concerttoursstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
