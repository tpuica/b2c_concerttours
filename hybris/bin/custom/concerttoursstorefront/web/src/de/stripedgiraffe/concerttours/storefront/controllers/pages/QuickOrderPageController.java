 ...
 */
package de.stripedgiraffe.concerttours.storefront.controllers.pages;
...
import de.stripedgiraffe.concerttours.storefront.controllers.ControllerConstants;
...
public class QuickOrderPageController extends AbstractPageController
{
	...
	public String getQuickOrderPage(final Model model) throws CMSItemNotFoundException // NOSONAR
	{
		...
		model.addAttribute("quickOrderMinRows", Integer.valueOf(Config.getInt("concerttoursstorefront.quick.order.rows.min", 3)));
		model.addAttribute("quickOrderMaxRows", Integer.valueOf(Config.getInt("concerttoursstorefront.quick.order.rows.max", 25)));
