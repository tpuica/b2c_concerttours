...
import de.stripedgiraffe.concerttours.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/concerttoursfulfilmentprocess/test/concerttoursfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/concerttoursfulfilmentprocess/test/concerttoursfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/concerttoursfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/concerttoursfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/concerttoursfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/concerttoursfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/concerttoursfulfilmentprocess/test/concerttoursfulfilmentprocess-spring-testcleanup.xml"));
