 ...
 */
package de.stripedgiraffe.concerttours.fulfilmentprocess.test.jobs;
...
import de.stripedgiraffe.concerttours.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = ConcerttoursFulfilmentProcessConstants.ORDER_PROCESS_NAME;
