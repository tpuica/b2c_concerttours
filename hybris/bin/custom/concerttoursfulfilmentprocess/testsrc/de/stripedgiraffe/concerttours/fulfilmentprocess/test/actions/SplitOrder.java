 ...
 */
package de.stripedgiraffe.concerttours.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ConcerttoursFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ConcerttoursFulfilmentProcessConstants.PARENT_PROCESS);
