 ...
 */
package de.stripedgiraffe.concerttours.core.suggestion;
...
import de.stripedgiraffe.concerttours.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/concerttourscore/test/testSimpleSuggestionService.csv", "utf-8");
	}
