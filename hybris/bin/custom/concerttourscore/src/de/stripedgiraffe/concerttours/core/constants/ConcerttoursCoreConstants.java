 ...
 */
package de.stripedgiraffe.concerttours.core.constants;

/**
 * Global class for all ConcerttoursCore constants. You can add global constants for your extension into this class.
 */
public final class ConcerttoursCoreConstants extends GeneratedConcerttoursCoreConstants
{
	public static final String EXTENSIONNAME = "concerttourscore";


	private ConcerttoursCoreConstants()
	{
		//empty
	}
