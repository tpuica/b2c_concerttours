...
public class DefaultConcerttourspromotionsService implements ConcerttourspromotionsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultConcerttourspromotionsService.class);
	...
	{
		return DefaultConcerttourspromotionsService.class.getResourceAsStream("/concerttourspromotions/sap-hybris-platform.png");
	}
