 ...
 */
package de.stripedgiraffe.concerttours.test.setup;
...
import de.stripedgiraffe.concerttours.test.constants.ConcerttoursTestConstants;
import de.stripedgiraffe.concerttours.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ConcerttoursTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/concerttourstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/concerttourstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/concerttourstest/import/cstickets.impex");
			...
			importImpexFile(context, "/concerttourstest/import/csquotes.impex");
		}
	}
}
